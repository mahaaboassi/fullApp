...
function Accordion({question,answer,withIcons=false,isFromFAQ=false}) {
   const [isOpen , setIsOpen] = useState(false)
   const contentRef = useRef(null);
   return ( <div onClick={()=>setIsOpen(!isOpen)} className={`cursor-pointer container-accordion p-3 ${isFromFAQ?"lg:p-10":"lg:p-6"}  mb-5 ${isOpen && "open"}`}>
        <div className="flex justify-between items-center accordion">
        ...
        <div style={{
            ...
            <div ref={contentRef}>
                <p  className="p-1 md:p-3  ">{answer}</p>
                {withIcons && <div className={`flex gap-2 px-1 md:px-3 pb-2 social-accordion`}>
                    <div className="social-icons-accordion">

...
function Hero() {
    ...
    return (<div  className='relative hero'>
        <div className={`px-2 flex flex-col gap-5 sm:px-5 md:px-7 ${i18n.language == "ar" ? "arabic-dir":"w-full en-dir"} `}>
            ...
            <div className='flex justify-center'><button className='btn-main p-4'>{t("partner-with-us-btn")}</button></div>
